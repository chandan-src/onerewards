                ...
                <div className="container">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-[#1A1A1A]/70 max-w-3xl mx-auto">
                            Get in touch with our team. We're here to help you transform your customer loyalty program.
                        </p>
                    </div>
                            ...
                            <CardContent className="p-8">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[#1A1A1A]/70">info@onerewards.com</p>
                                    </div>
                                    <div>
                        ...
                        <Card className="border-none shadow-lg">
                            <CardContent className="p-8">
                                ...
                                <div className="flex space-x-6">
                                    <a href="#" className="text-[#1A1A1A] hover:text-[#EC7508] transition-colors">

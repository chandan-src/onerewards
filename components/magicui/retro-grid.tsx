      ...
      <div className="absolute inset-0 [transform:rotateX(var(--grid-angle))]">
        <div
          className="
            ...
            animate-[grid_var(--animation-speed)_linear_infinite_reverse]
          "
        >
          <div className="absolute inset-0 animate-pulse bg-gradient-to-t from-transparent via-white/10 to-transparent dark:via-black/10" />
        </div>
      </div>

      <div className="absolute inset-0 bg-gradient-to-t from-white via-transparent to-transparent dark:from-black">
        <div className="absolute inset-0 animate-pulse bg-gradient-to-r from-transparent via-white/20 to-transparent dark:via-black/70" />
      </div>
    </div>
  );
}
